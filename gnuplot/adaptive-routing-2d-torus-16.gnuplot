set yrange [0:4]
set key top left font "GothicBBB-Medium-RKSJ-H, 20"
...
plot  'adaptive-routing-2d-torus-16.txt' using ($2):xtic(1) title "dimension order routing", '' using ($6) title "dynamic X-Y routing", '' using ($5) title "MiniCAR"
#, '' using ($3) title "dimension adaptive routing", '' using ($4) title "minimal oblivious routing"

#set terminal png         # gnuplot recommends setting terminal before output
#set output 'adaptive-routing-2d-torus-16-minicar.png'  
 
set terminal postscript eps 20
#set term post eps color     
set output 'adaptive-routing-2d-torus-16-minicar.eps'  
replot
